...
use synopsie\database\result\SqlChangeResult;
use synopsie\database\result\SqlColumnInfo;
use synopsie\database\result\SqlInsertResult;
use synopsie\database\result\SqlSelectResult;
